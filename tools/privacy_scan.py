...
SAFE_DOMAINS = {'example.test', 'example.invalid', 'example.com', 'example.org', 'users.noreply.github.com'}
SAFE_EMAILS = {'bridge-manual@users.noreply.github.com', 'git@github.com', 'noreply@github.com'}
